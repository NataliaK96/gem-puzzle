...
generateField.addEventListener('click',()=>{
  ...
  mygame.container.remove()
  mygame.removeInterval()
  mygame = new _GemPuzzle__WEBPACK_IMPORTED_MODULE_0__["GemPuzzle"](2)
})
